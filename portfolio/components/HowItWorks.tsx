...
export default function HowItWorks() {
  return (
    <section className="relative isolate pt-24 tablet:pt-52 desktop:pt-72 mt-24 overflow-hidden font-raleway tablet:py-32">
      ...
      <picture>
        <source srcSet="/assets/ellipse/ellipse.webp" type="image/webp" />
        <img
          src="/assets/ellipse/ellipse.png"
          ...
          {HOW_IT_WORKS_ITEMS.map(({ title, copy, img }, idx) => (
            ...
            >
              <picture>
                <source
                  srcSet={`
                    /assets/how-it-works/${img}-480.webp 480w,
                    /assets/how-it-works/${img}-768.webp 768w,
                    /assets/how-it-works/${img}-1024.webp 1024w
                  `}
                ...
                <source
                  srcSet={`
                    /assets/how-it-works/${img}-480.png 480w,
                    /assets/how-it-works/${img}-768.png 768w,
                    /assets/how-it-works/${img}-1024.png 1024w
                  `}
                  sizes="(max-width: 768px) 70vw, 33.33vw"
                  type="image/jpeg"
                />
                <img
                  src={`/assets/how-it-works/${img}-1024.png`}
                  alt={title}
                  decoding="async"
                  loading="lazy"
                  width={1024}
