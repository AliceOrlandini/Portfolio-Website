...
export default function Navbar() {
  return (
    <nav className="font-jakarta flex justify-between items-center px-10 py-5">
      ...
      <div>
        <ul className="flex gap-14 text-base font-semibold text-navigation items-center">
          <li className="hover:cursor-pointer hover:scale-110 transition-transform duration-300">Home</li>
          <li className="hover:cursor-pointer hover:scale-110 transition-transform duration-300">About</li>
