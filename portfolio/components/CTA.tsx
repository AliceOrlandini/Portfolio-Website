...
export default function CTA() {
  return (
    <section className="mx-32 rounded-xl bg-primary text-white pb-10">
      <div className="grid grid-cols-12 gap-4 px-20 pt-20">
        <div className="col-span-6">
          <h1 className="text-5xl font-bold leading-14">Hai un&#39;attività in provincia di Lucca e Pisa? Mettiamo il sito online insieme!</h1>
          <p className="mt-10 text-lg font-medium">Che tu abbia un negozio, uno studio, un ristorante o un progetto personale, avere un sito web ti aiuta a farti trovare e a raccontare chi sei. Ti seguo passo passo: dalla scelta dei contenuti alla messa online, in modo semplice e senza stress. Scrivimi e iniziamo a costruire qualcosa di bello!</p>
