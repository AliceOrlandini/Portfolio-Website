...
export const metadata: Metadata = {
  ...
  description:
    'Nel mio blog trovi guide pratiche, esperienze reali, consigli tech e supporto per studenti: sviluppo web, coding e molto altro.',
  icons: {
    icon: [
  ...
  openGraph: {
    ...
    images:
      'https://cdn.jsdelivr.net/gh/AliceOrlandini/Portfolio-Website@b3b6982/portfolio/assets/icon/icon2.png',
    locale: 'it-IT',
    type: 'website'
  },
      ...
      >
        ...
        <JsonLd
          data={{
            ...
            description:
              'Alice Orlandini è una blogger e sviluppatrice web con esperienza in HTML, CSS, JavaScript e PHP. Condivide le sue conoscenze attraverso articoli e guide pratiche.',
            sameAs: [
